...
function move(numberOfSteps, direction) {
    ...
    switch (direction) {
        case "E":
            queen.position.y + numberOfSteps;
            if (temp > 8 && temp < 0) {
        ...
        case "W":
            ...
            break;
        case "S":
            queen.position.x + numberOfSteps;
            if (temp > 8 && temp < 0) {
                console.log("Out of boundary");
                document.write("'Out of boundary");
            } else {
        ...
        case "SE":
            ...
            if ((temp1 > 8 || temp1 < 0) && (temp > 8 || temp < 0)) {
                console.log("Out of boundary");
                document.write("'Out of boundary");
            } else {
...
function play() {
    ...
    console.log("Queen current position" + board[queen.position.x][queen.position.y])
}